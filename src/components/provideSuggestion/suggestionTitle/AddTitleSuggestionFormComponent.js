...
mutation CreateTranslationProposal($anime_id: UUID!, $proposition: String!, $language: Languages!){
...
export function AddTitleSuggestionFormComponent(props){
...
export default AddTitleSuggestionFormComponent